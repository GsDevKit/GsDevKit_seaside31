...
$GS_HOME/etc/GsDevKit_seaside/tests/travisCustomize.sh

case $TEST in
  Seaside3) $GS_HOME/etc/GsDevKit_seaside/tests/testSeaside3.sh ;;
  Seaside3Upgrade) $GS_HOME/etc/GsDevKit_seaside/tests/testSeaside3Upgrade.sh ;;
  *)
